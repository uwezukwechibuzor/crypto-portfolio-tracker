...
A production-ready cryptocurrency portfolio tracker supporting Ethereum and Solana blockchains. Built with Flask, PostgreSQL, and Redis.
...
- **Cache**: Redis 7
- **Blockchain**: Web3.py (Ethereum), Solana.py (Solana)
- **Validation**: Pydantic
- **Migrations**: Alembic
- **Logging**: Loguru
